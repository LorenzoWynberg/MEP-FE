...
class ColorSwitcher extends Component {
  constructor (props) {
    ...
    this.state = {
      isOpen: false,
      selectedColor: localStorage.getItem(envVariables.THEME_COLOR_STORAGE_KEY),
      radius: localStorage.getItem(envVariables.THEME_RADIUS_STORAGE_KEY) || 'rounded'
    }
  }
  ...
  changeRadius = radius => {
    ...
    localStorage.setItem(envVariables.THEME_RADIUS_STORAGE_KEY, radius)
  }
