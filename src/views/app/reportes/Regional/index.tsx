...
const ReporteRegional = props => {
	...
	const reportes =
		props.props.tipo == 'sce'
			...
			: [
					{
						titulo: t(
							'reportes>regional>reporte_de_matricula_por_direccion_regional',
							'Reporte de Matrícula por Dirección Regional'
						),
						descripcion: t(
							'reportes>regional>resumen_de_estudiantes_matriculados_por_centro_educativo',
	...
	return (
        ...
        <ReporteMatriculaActual regresarEvent={() => setState(0)} />
			...
			{state == 1 && <ReporteMatriculaPorRegion regresarEvent={() => setState(0)} />}

			{state == 2 && <GetHistoricoEstDivisionAdminReg regresarEvent={() => setState(0)} />}
