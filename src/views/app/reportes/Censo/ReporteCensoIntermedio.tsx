	...
	const Row = (key, item) => {
		return (
			<tr key={key}>
				...
				<td>{item.condicionCensoIntermedio}</td>
			</tr>
		)
	}
	const contarCensos = () => {
	...
	return (
		<div ref={innerRef}>
            ...
            `}
					...
					<p>
						<b>
							Censo Intermedio 2024 - registro de condición censo intermedio del
							estudiante
						</b>
					</p>
				</SeccionCentrada>
				...
				<p>
					<Table>
						<thead>
							...
							<th>Condición censo intermedio</th>
						</thead>
						<tbody>
