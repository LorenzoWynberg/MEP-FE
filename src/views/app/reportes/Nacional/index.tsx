...
import ReporteMatriculaActual from './ReporteMatriculaActual'
import ReporteAulasInstitucion from './ReporteAulasInstitucion'
import ReporteInformacionAccesoInstitucion from './ReporteInformacionAccesoInstitucion'
import ReporteServiciosPublicosInstitucion from './ReporteServiciosPublicosInstitucion'
const ReportesNacional = () => {
  ...
  return (
    <>
      ...
      {state == 2 && (
        <ReporteAulasInstitucion regresarEvent={() => setState(0)} />
      )}
      {state == 3 && (
