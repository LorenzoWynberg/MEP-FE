...
const ReporteAulasInstitucion = ({ regresarEvent }) => {
  ...
  const loadReportData = async (institucionId) => {
    try {
      const response = await axios.get(
				`${envVariables.BACKEND_URL}/api/Areas/Reportes/ReportesGenerales/GetAulasPorInstitucionId?institucionId=${institucionId}`
      )
...
export default ReporteAulasInstitucion
