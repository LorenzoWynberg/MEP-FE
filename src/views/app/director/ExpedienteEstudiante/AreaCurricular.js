...
const AreaCurricular = (props) => {
  ...
  return (
    <Grid container className={classes.root} spacing={2}>
      ...
      <Grid item xs={12}>
        <h4>{t('estudiantes>expediente>area_curric>titulo', 'Área curricular')}</h4>
        <br />
      </Grid>
          ...
          <Paper className={classes.paper}>
            <Grid container>
              ...
              <Grid item xs={12} className={classes.control}>
                <FormControl component='fieldset'>
                  <FormLabel component='legend'>
                    {t('estudiantes>expediente>area_curric>educ_religiosa', '¿Recibe Educación Religiosa?')}
                  </FormLabel>
              ...
              <Grid item xs={12} className={classes.control}>
                <FormControl component='fieldset'>
                  <FormLabel component='legend'>
                    {t('estudiantes>expediente>area_curric>afectividad_sexualidad', '¿Recibe el programa de Educación para la Afectividad y Sexualidad Integral?')}
                  </FormLabel>
                  <RadioGroup
                    aria-label='program'
                    name='program'
