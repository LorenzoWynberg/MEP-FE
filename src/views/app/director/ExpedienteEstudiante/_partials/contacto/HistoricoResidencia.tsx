  ...
  const columns = useMemo(() => [
    {
      ...
      Cell: ({ row }) => {
        return (
          <div>{moment(row.original?.fechaInsercion)?.format('DD/MM/YYYY HH:mm')} </div>
        )
      }
    },
    {
    ...
    <>
      <Card>
        <CardBody>
          ...
          <h1>{t('estudiantes>expediente>contacto>historico_residencia>titulo', 'Historico de Residencias')}</h1>
