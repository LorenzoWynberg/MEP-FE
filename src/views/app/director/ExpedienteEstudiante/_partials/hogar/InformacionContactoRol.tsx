    ...
    <Card className='mt-5'>
      <CardBody>
        <Row>
          <Col sm='12' md='12'>
            <h5>
              {t('estudiantes>expediente>hogar>miembros_hogar>agregar>info_contac', 'Información de Contacto')}
            </h5>
          </Col>
          <Col sm='12' md='12'>
            <FormGroup>
              {props.label
                ? (
                  <Label>*{t('estudiantes>expediente>hogar>miembros_hogar>agregar>tel_prin', 'Teléfono principal')}</Label>
                  )
                : (
                  <RequiredLabel>
              ...
              <FormFeedback>
                {props.fields.Telefono &&
									props.errors.Telefono.replace(
									  "'Telefono'",
									  'Telefóno'
									)}
              </FormFeedback>
          ...
          <Col sm='12' md='12'>
            <FormGroup>
              {props.label
                ? (
                  <Label>*{t('estudiantes>expediente>hogar>miembros_hogar>agregar>correo', 'Correo electrónico')}</Label>
                  )
                : (
                  <RequiredLabel>
