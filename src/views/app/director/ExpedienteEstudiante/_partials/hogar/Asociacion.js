    ...
    <Card>
      <CardBody>
        <Row>
          <Col sm='12' md='12'>
            <h5>
              {t('estudiantes>expediente>hogar>miembros_hogar>agregar>asociacion', 'Asociación')}
            </h5>
          </Col>
          <Col sm='12' md='12'>
            <FormGroup>
              <Label>
                *{t('estudiantes>expediente>hogar>miembros_hogar>agregar>relacion_est', 'Relación con estudiante')}
              </Label>
              <Select
            ...
            <FormGroup>
              <Label>
                {t('estudiantes>expediente>hogar>miembros_hogar>agregar>encargado_est', '¿Es el encargado del estudiante?')}
              </Label>
              <div>
                <CustomInput
                  type='radio' inline label={t('general>si', 'Si')} checked={props.memberData.encargado} onClick={() => {
                    if (props.editable) {
                ...
                />
                <CustomInput
                  type='radio' inline label={t('general>no', 'No')} checked={!props.memberData.encargado} onClick={() => {
                    if (props.editable) {
                ...
                <ButtonsContainer>
                  ...
                  {props.memberData.recursosIdsEncargado && props.memberData.recursosIdsEncargado.length > 0 &&
                    <Button
                      ...
                      >
                        {t('general>subir_archivo', 'Subir Archivo')}{`(${props.memberData.recursosIdsEncargado.length} archivos)`}
                      </Button>}
                </ButtonsContainer>}
            </FormGroup>
          </Col>
          <Col sm='12' md='12'>
            <FormGroup>
              <Label>
                {t('estudiantes>expediente>hogar>miembros_hogar>agregar>represen_legal_est', '¿Es el representante legal del estudiante?')}
              </Label>
              <div>
                <CustomInput
                  type='radio' inline label={t('general>si', 'Si')} checked={props.memberData.representanteLegal} onClick={() => {
                    if (props.editable) {
                ...
                />
                <CustomInput
                  type='radio' inline label={t('general>no', 'No')} checked={!props.memberData.representanteLegal} onClick={() => {
                    if (props.editable) {
              ...
              {props.memberData.representanteLegal && <ButtonsContainer>
                ...
                {props.memberData.recursosIdsRepresentante && props.memberData.recursosIdsRepresentante.length > 0 &&
                  ...
                  >
                    {t('general>subir_archivo', 'Subir Archivo')}{`(${props.memberData && props.memberData.recursosIdsRepresentante.length} archivos)`}
                  </Button>}
                                                      </ButtonsContainer>}
            </FormGroup>
          </Col>
          <Col sm='12' md='12'>
            <FormGroup>
              <Label>
                {t('estudiantes>expediente>hogar>miembros_hogar>agregar>autorizado', 'Autorizado')}
              </Label>
              <div>
                <CustomInput
                  type='radio' inline label={t('general>si', 'Si')} checked={props.memberData.autorizado} onClick={() => {
                    if (props.editable) {
                ...
                />
                <CustomInput
                  type='radio' inline label={t('general>no', 'No')} checked={!props.memberData.autorizado} onClick={() => {
                    if (props.editable) {
          ...
          <Col sm='12' md='12'>
            <FormGroup>
              <Label>
                {t('estudiantes>expediente>hogar>miembros_hogar>agregar>vive_est', 'Vive con estudiante')}
              </Label>
              <div>
                <CustomInput
                  type='radio' inline label={t('general>si', 'Si')} checked={props.memberData.viveHogar} onClick={() => {
                    if (props.editable) {
                ...
                />
                <CustomInput
                  type='radio' inline label={t('general>no', 'No')} checked={!props.memberData.viveHogar} onClick={() => {
                    if (props.editable) {
          ...
          <Col sm='12' md='12'>
            <FormGroup>
              <Label>
                {t('estudiantes>expediente>hogar>miembros_hogar>agregar>depende_econ_est', '¿Depende economicamente del estudiante?')}
              </Label>
              <div>
                <CustomInput
                  type='radio' inline label={t('general>si', 'Si')} checked={props.memberData.dependenciaEconomica} onClick={() => {
                    if (props.editable) {
                ...
                />
                <CustomInput
                  type='radio' inline label={t('general>no', 'No')} checked={!props.memberData.dependenciaEconomica} onClick={() => {
                    if (props.editable) {
