...
const OtrosDatos = props => {
  ...
  //   debugger
  //   if (options.length === 0) {
  //     setOptions(props.ocupaciones.map(
  //       item => ({
  //         label: item.nombre,
  //         value: item.id
  //       })
  ...
  return (
    <Col sm='12' md='8' className='m-0 p-0'>
      ...
      <Card>
        <CardBody>
          <CardTitle>{t('estudiantes>expediente>hogar>otros_datos>titulo', 'Otros datos del estudiante')}</CardTitle>
          <Form>
            <Row>
