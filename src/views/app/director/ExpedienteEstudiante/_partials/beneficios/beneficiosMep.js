...
import {
  ...
  deleteSubsidio,
  editSubsidio,
  editSubsidioBody, GetSubsidiosMEP
...
const BeneficiosMEP = (props) => {
  ...
  const handleViewSubsidio = async (e, show) => {
    ...
    setPrevSubsidio(
      tipos.find((tipo) => tipo?.nombre == e?.nombreTipoSubsidio)
    )
    setShowButtons(show)
  }
        ...
        <>
          ...
          <Form
            onSubmit={handleSubmit((data) =>
						  props.authHandler('modificar', () => sendData(data))
            )}
          >
