...
const ApoyoItem = (props) => {
  ...
  return (
    <Container>
      ...
      <Form onSubmit={handleSubmit(props.apoyo.id ? (data) => props.authHandler('modificar', handleSaveApoyo(data)) : (data) => props.authHandler('crear', handleSaveApoyo(data)))} inline>
        {props.apoyosMateriales && (
          <Col>
            <FormGroup>
              ...
              >
                <option value={null}>{t('estudiantes>expediente>apoyos_edu>apoyos_mater_tech>dependencia_apoyo', 'Dependencia de apoyo')}</option>
