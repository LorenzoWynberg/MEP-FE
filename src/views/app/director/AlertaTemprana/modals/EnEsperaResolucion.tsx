...
const EsperaResolucion: React.FC<ComentariosAlertaProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <StyledModalBody>
        <Textarea value={comments} cols='3' rows='5' onChange={handleChange} />
        <Actions>
...
export default EsperaResolucion
