...
const fieldIds = {
  ...
  facebook: '91a9dba4-07e2-3663-8e22-1ded7307dee9_398f5e08-429f-9bee-3c80-dd15d2b5065d_col_facebook',
  whatsapp: '91a9dba4-07e2-3663-8e22-1ded7307dee9_398f5e08-429f-9bee-3c80-dd15d2b5065d_col_whatsapp',
  instagram: '91a9dba4-07e2-3663-8e22-1ded7307dee9_398f5e08-429f-9bee-3c80-dd15d2b5065d_col_instagram',
  twitter: '91a9dba4-07e2-3663-8e22-1ded7307dee9_398f5e08-429f-9bee-3c80-dd15d2b5065d_col_twitter',
  telephone: 'f26f66d0-936a-b6f4-c161-4cd9a4b84339_89e0ec4e-1a1b-def9-311d-5136ff311910_col',
  telephoneName: 'c8851fbf-ea92-4123-8678-ad474d14493f_89e0ec4e-1a1b-def9-311d-5136ff311910_col',
  tableValues: '49465a64-9674-ec8c-e1a7-ac0b94bdd6e9_46eacd9e-16b2-c92b-fb3d-3722f850f5a2_col',
    ...
    return [
      ...
      },
      {
        ...
        Cell: ({ row }) => {
          return (
            <>
              {row?.original?.solucion.tablesData[fieldIds.tableValues] ? row?.original?.solucion.tablesData[fieldIds.tableValues]['0'].columnValues['0'].value : null}
            </>
          )
        }
      },
              ...
              <Row>
                <Col xs={12} md={12}>
                  {!loading && !showForm ? (
                    ...
                    <FormGroup>
                    <Label>
                    {t('dir_regionales>ver>correo_electronico', 'Correo electronico')}
                  </Label>
                    <Input
                    type='text'
                    value={
                  ...
                  />
                    ...
                    <FormGroup>
                    <Label>{t('dir_regionales>ver>web', 'Web')}</Label>
                    <Input
                    type='text'
                    value={
																formResponse[
                  ...
                  />
                    ...
                    <CardTitle>
                    {t('dir_regionales>ver>tel_asociados', 'Teléfonos asociados')}
                  </CardTitle>
                    <div>
                    {/* <br /> */}
                    <div>
                  ...
                  />
                    <span>
                    * {t('dir_regionales>ver>tel_mensaje', 'Puede dar clic al teléfono para ver las extensiones')}
                  </span>
                    <RedesSociales
