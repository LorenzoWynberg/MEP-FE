...
const InformationCardExpediente = ({ data }) => {
  ...
  return (
    <DivContainer>
      ...
      <Columna>
        <span>
          {t('informationcardexpediente>nombre', 'Nombre')}: {state.institucion.nombre}
        </span>
        <span>
          {t('informationcardexpediente>identificacion', 'Identificación')}: {state.institucion.codigo}
        </span>
        <span>
          {t('informationcardexpediente>grupo', 'Grupo')}: {state.institucion.codigoPresupuestario}
        </span>
      </Columna>
      <Columna>
        <span>
          {t('informationcardexpediente>oferta', 'Oferta Educativa')}: {state.institucion?.regionNombre}
        </span>
        <span>
          {t('informationcardexpediente>modalidad', 'Modalidad')}: {state.institucion.circuitoNombre}
        </span>
        <span>
          {t('informationcardexpediente>nivel', 'Nivel')}: {state.institucion?.esPrivado ? 'Privada' : 'Pública'}
        </span>
      </Columna>
      <Columna>
        <span>
          {t('informationcardexpediente>codigo', 'Código')}: {locationInfo.provincia}
        </span>
        <span>
          {t('informationcardexpediente>nombreCentroEducativo', 'Nombre Centro Educativo')}: {locationInfo.canton}
        </span>
        <span>
          {t('informationcardexpediente>estadoEstudiantePeriodo', 'Estado Estudiante Periodo Educativo')}: {locationInfo.distrito}
        </span>
      </Columna>
    </DivContainer>
  )
...
export default InformationCardExpediente
