...
import { actualizarServicioComunal, getTablaEstudiantesServicioComunalById, GetServicioComunalInfoById } from '../../../../redux/configuracion/actions'
...
export const ServicioComunalEdit: React.FC<IProps> = props => {
...
export default withRouter(ServicioComunalEdit)
