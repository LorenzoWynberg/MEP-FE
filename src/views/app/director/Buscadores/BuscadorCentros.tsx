						...
						>
							<Tooltip
								title={t(
									...
									'Ver ficha del centro educativo'
								)}
							>
								<RemoveRedEyeRounded
									onClick={() =>
										props.history.push(`/director/ficha-centro/${fullRow.institucionId}`)
									}
									style={{
										fontSize: 25,
										color: colors.darkGray,
							...
							<Tooltip
								title={t(
									'buscador_ce>buscador>columna_acciones>seleccionar',
...
export default withRouter(BuscadorCentros)
