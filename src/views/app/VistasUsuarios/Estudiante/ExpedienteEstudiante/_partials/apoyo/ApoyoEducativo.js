...
const ApoyoEducativo = (props) => {
  ...
  return (
    <Card>
      <CardBody>
        <CardTitle>Apoyos educativos del estudiante</CardTitle>
        <Row>
          <Col md='12'>
            <Row>
              <Col md='6'>
              ...
              <Col md='6'>
                <span>Detalle de la condición de discapacidad</span>
                <ButtonsContainer>
          ...
          <Col md='12'>
            <Row>
              <Col md='6'>
                <FormGroup>
                  <Label>Otro tipo de condición</Label>
                  <StyledMultiSelect
                    className={classes.inputTags}
                    disabled={!editable}
                    onClick={() => {
              ...
              <Col md='6'>
                <span>Recomendaciones a docentes</span>
                <ButtonsContainer>
                  <DownloadIconContainer>
                    <i className='simple-icon-cloud-upload' />
                  </DownloadIconContainer>
