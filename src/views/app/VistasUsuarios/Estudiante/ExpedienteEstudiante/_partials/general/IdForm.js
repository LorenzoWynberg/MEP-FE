            ...
            <div className='container-center container-avatar-expediente'>
              <div className='content-avatar-expediente mb-3'>
                <Form id='image_form'>
                  {props.editable && (
                    <>
                      <span>*{t('estudiantes>expediente>info_gen>info_gen>img_mensaje','Haga Click en la imagen para cambiarla')}</span>
                      <input
                        accept='image/*'
                  ...
                  {image.preview
                    ? (
                      <label htmlFor='icon-button-file' id='student-photo'>
                        <Avatar
                          alt={props.identification.data.id}
                          src={image.preview}
