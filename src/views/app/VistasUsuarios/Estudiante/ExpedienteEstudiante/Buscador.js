...
import { cleanStudentsFilter, getStudentDataFilter, changeColumn, changeFilterOption, loadStudent } from '../../../../../redux/expedienteEstudiantil/actions'
import BuscadorTable from 'Components/buscador-table'

const Buscador = (props) => {
  const { estudiantes, cleanIdentity, cleanStudentsFilter, buscador, changeColumn, changeFilterOption, loadStudent } = props
  ...
  return (
    <div>
      <Colxx xxs='12'>
        <Breadcrumb heading='Expediente estudiante' match={props.match} hidePath />
        <br />
