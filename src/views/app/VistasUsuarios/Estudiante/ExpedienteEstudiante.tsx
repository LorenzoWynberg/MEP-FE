  ...
  return (
    <div>
      ...
      <section>
        ...
        <span>
          Aquí podrá encontrar la información general relacionada con la persona
          estudiante
        </span>
        <CardContainer>
      ...
      <section>
        ...
        <span>
          Aquí podrá encontrar la información de los horarios, calificaciones y
          demás de cada centro educativo donde se encuentra matriculada la
          persona estudiante
        </span>
        <CardContainer>
