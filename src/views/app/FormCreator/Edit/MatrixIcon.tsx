...
const MatrixIcon = (props) => {
  return (
    <svg id='apps_black_24dp' xmlns='http://www.w3.org/2000/svg' width='22.226' height='22.226' viewBox='0 0 22.226 22.226'>
