...
const EditNormativasModal: React.FC<IProps> = (props) => {
  const { register, errors, handleSubmit } = useForm({
    mode: 'onChange',
    defaultValues: {
      id: props.normativa.id,
      url: props.normativa.url,
      nombre: props.normativa.nombre
    }
  })

  const onSubmit = (values: any) => {
    props.handleUpdate({ ...values, id: props.normativa.id })
  }
...
export default EditNormativasModal
