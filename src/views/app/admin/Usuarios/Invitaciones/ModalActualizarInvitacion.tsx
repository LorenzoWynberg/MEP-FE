...
const ModalActualizarInvitacion: React.FC<IProps> = (props) => {
  const {
    register,
    errors,
    control,
  ...
  const onSubmit = data => {
    props.handleSubmit(data, props.currentInvitation.invitacionId)
  }
          ...
          <Row>
            <Col md={6}>
              <FormGroup>
                ...
                <ContentInput>
                  <Controller
                    defaultValue={selects.idTypes.find((item: any) => item.id === props.currentInvitation.tipoIdentificacionId)}
                    as={<StyleSelect
              ...
              <FormGroup>
                ...
                <ContentInput>
                  <Controller
                    defaultValue={selects.nationalities.find((item: any) => item.id === props.currentInvitation.nacionalidadId)}
                    as={<StyleSelect
                        components={{ Input: CustomSelectInput }}
                        className='react-select'
                        classNamePrefix='react-select'
              ...
              <FormGroup>
                ...
                <ContentInput>
                  <Input
                    ...
                    value={props.currentInvitation.identificacion || ''}
                  />
              ...
              <FormGroup>
                ...
                <ContentInput>
                  <Controller
                    ...
                    defaultValue={props.currentInvitation.fechaNacimiento ? moment(props.currentInvitation.fechaNacimiento).toDate() : null}
                    placeholderText=''
              ...
              <FormGroup>
                ...
                <ContentInput>
                  <Input
                    ...
                    autoComplete='off'
                    defaultValue={props.currentInvitation.email || ''}
                  />
                  {errors.email && errors.email.type === 'required' && <ErrorFeedback>Campo requerido</ErrorFeedback>}
                  {errors.email && errors.email.type === 'pattern' && <ErrorFeedback>Dirección invalida</ErrorFeedback>}
                </ContentInput>
              </FormGroup>
              <FormGroup>
                <Label>Nombre</Label>
                <ContentInput>
                  <Input
                    ...
                    autoComplete='off'
                    defaultValue={props.currentInvitation.nombre || ''}
                  />
              ...
              <FormGroup>
                ...
                <ContentInput>
                  <Input
                    ...
                    ref={register({ required: true })}
                    autoComplete='off'
                    defaultValue={props.currentInvitation.apellido || ''}
                  />
                  {errors.apellido && <ErrorFeedback>Campo requerido</ErrorFeedback>}
                </ContentInput>
              </FormGroup>
              <FormGroup>
                ...
                <ContentInput>
                  <Input
                    ...
                    ref={register({ required: true })}
                    autoComplete='off'
                    defaultValue={props.currentInvitation.segundoApellido || ''}
                  />
...
export default ModalActualizarInvitacion
