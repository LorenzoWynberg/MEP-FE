        ...
        <Form>
          ...
          <FormGroup>
            <FormControlLabel
              control={
                <IOSSwitch
                  checked={props.field.config.orientation == 'column'}
                  onClick={() => {
                    const orientation = (props.field.config.orientation == 'column') ? 'row' : 'column'
                    props.handleChange('orientation', orientation, true)
                  }}
                  name='orientation'
                  color='primary'
                />
