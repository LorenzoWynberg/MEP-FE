  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 55 55' space='preserve' {...props}>
      <g transform='translate(-358 2009)'>
        <StyledA class='a' d='M0,0H59.882V59.882H0Z' transform='translate(358 -2009)' />
        <g transform='translate(892.274 -1959.56)'>
          <StyledBPath d='M-490.432-35.458a3.115,3.115,0,0,0-3.115,3.115v25.11c-.055,1.016-.773,8.466-10.211,8.466h-1.013c-9.188,0-10.12-7.108-10.211-8.479v-25.1a3.115,3.115,0,0,0-3.115-3.115,3.115,3.115,0,0,0-3.115,3.115V-7.161l0,.124c.19,4.776,3.873,13.808,16.439,13.808h1.013c12.566,0,16.249-9.032,16.44-13.808l0-25.306A3.115,3.115,0,0,0-490.432-35.458Z' transform='translate(0 -2.608)' />
          ...
          <StyledBCircle cx='3.292' cy='3.292' r='3.292' transform='translate(-504.356 -39.278) rotate(-45)' />
        </g>
      </g>
    </svg>
  )
